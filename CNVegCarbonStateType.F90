...
#include "shr_assert.h"
  ...
  type, public :: cnveg_carbonstate_type
     ...
     ! shsun
     real(r8), pointer :: herbivc_patch            (:) ! (gC/m2) pool for herbivore
     real(r8), pointer :: herbivc_col              (:) ! (gC/m2) column-level herbic
     real(r8), pointer :: herbivc_resp_patch            (:) ! (gC/m2) pool for herbivore respiration
     real(r8), pointer :: herbivc_resp_col              (:) ! (gC/m2) column-level herbivore respiration
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%herbivc_patch            (begp:endp)) ; this%herbivc_patch            (:) = nan
    allocate(this%herbivc_col              (begc:endc)) ; this%herbivc_col              (:) = nan
    allocate(this%herbivc_resp_patch       (begp:endp)) ; this%herbivc_resp_patch       (:) = nan
    allocate(this%herbivc_resp_col         (begc:endc)) ; this%herbivc_resp_col         (:) = nan
  ...
  subroutine InitHistory(this, bounds, carbon_type)
    ...
    if (carbon_type == 'c12') then
       ...
       ! shsun
       this%herbivc_patch(begp:endp) = spval
       call hist_addfld1d (fname='HERBIVC', units='gC/m^2', &
            avgflag='A', long_name='herbivore C', &
            ptr_patch=this%herbivc_patch)

       this%herbivc_col(begc:endc) = spval
       call hist_addfld1d (fname='HERBIVCCOL', units='gC/m^2', &
            avgflag='A', long_name='herbivore C in column', &
            ptr_col=this%herbivc_col)

       this%herbivc_resp_patch(begp:endp) = spval
       call hist_addfld1d (fname='HERBIVC_RESP', units='gC/m^2', &
            avgflag='A', long_name='herbivore respiration C', &
            ptr_patch=this%herbivc_resp_patch)

       this%herbivc_resp_col(begc:endc) = spval
       call hist_addfld1d (fname='HERBIVC_RESP_COL', units='gC/m^2', &
            avgflag='A', long_name='herbivore respiration C in column', &
            ptr_col=this%herbivc_resp_col)
    ...
    if ( carbon_type == 'c13' ) then
       ...
       ! shsun
       this%herbivc_patch(begp:endp) = spval
       call hist_addfld1d (fname='C13_HERBIVC', units='gC13/m^2', &
            avgflag='A', long_name='C13 herbivore C', &
            ptr_patch=this%herbivc_patch)

       this%herbivc_col(begc:endc) = spval
       call hist_addfld1d (fname='C13_HERBIVCCOL', units='gC13/m^2', &
            avgflag='A', long_name='C13 herbivore C in column', &
            ptr_col=this%herbivc_col)

       this%herbivc_resp_patch(begp:endp) = spval
       call hist_addfld1d (fname='C13_HERBIVC_RESP', units='gC13/m^2', &
            avgflag='A', long_name='C13 herbivore respiration C', &
            ptr_patch=this%herbivc_resp_patch)

       this%herbivc_resp_col(begc:endc) = spval
       call hist_addfld1d (fname='C13_HERBIVC_RESP_COL', units='gC13/m^2', &
            avgflag='A', long_name='C13 herbivore respiration C in column', &
            ptr_col=this%herbivc_resp_col)
    ...
    if ( carbon_type == 'c14') then
       ...
       ! shsun
       this%herbivc_patch(begp:endp) = spval
       call hist_addfld1d (fname='C14_HERBIVC', units='gC14/m^2', &
            avgflag='A', long_name='C14 herbivore C', &
            ptr_patch=this%herbivc_patch)

       this%herbivc_col(begc:endc) = spval
       call hist_addfld1d (fname='C14_HERBIVCCOL', units='gC14/m^2', &
            avgflag='A', long_name='C14 herbivore C in column', &
            ptr_col=this%herbivc_col)

       this%herbivc_resp_patch(begp:endp) = spval
       call hist_addfld1d (fname='C14_HERBIVC_RESP', units='gC14/m^2', &
            avgflag='A', long_name='C14 herbivore respiraton C', &
            ptr_patch=this%herbivc_resp_patch)

       this%herbivc_resp_col(begc:endc) = spval
       call hist_addfld1d (fname='C14_HERBIVC_RESP_COL', units='gC14/m^2', &
            avgflag='A', long_name='C14 herbivore C respiration in column', &
            ptr_col=this%herbivc_resp_col)
  ...
  subroutine InitCold(this, bounds, ratio, carbon_type, c12_cnveg_carbonstate_inst)
    ...
    do p = bounds%begp,bounds%endp
       ...
       if (lun%itype(l) == istsoil .or. lun%itype(l) == istcrop) then
          ...
          ! shsun
          this%herbivc_patch(p)            = 0._r8
          this%herbivc_resp_patch(p)       = 0._r8
...
!          this%totgrainc_col(c)  = 0._r8
          ...
          ! shsun
          this%herbivc_col(c)    = 0._r8
          this%herbivc_resp_col(c) = 0._r8
  ...
  subroutine Restart ( this,  bounds, ncid, flag, carbon_type, reseed_dead_plants, &
    ...
    if (carbon_type == 'c12') then
       ...
       ! shsun
       call restartvar(ncid=ncid, flag=flag, varname='herbivc', xtype=ncd_double,  &
            dim1name='pft', long_name='', units='', &
            interpinic_flag='interp', readvar=readvar, data=this%herbivc_patch) 
       call restartvar(ncid=ncid, flag=flag, varname='herbivc_resp', xtype=ncd_double,  &
            dim1name='pft', long_name='', units='', &
            interpinic_flag='interp', readvar=readvar, data=this%herbivc_resp_patch) 
    ...
    if ( carbon_type == 'c13')  then
       ...
       ! shsun
       call restartvar(ncid=ncid, flag=flag, varname='herbivc_13', xtype=ncd_double,  &
            dim1name='pft', long_name='', units='', &
            interpinic_flag='interp', readvar=readvar, data=this%herbivc_patch)

       call restartvar(ncid=ncid, flag=flag, varname='herbivc_resp_13', xtype=ncd_double,  &
            dim1name='pft', long_name='', units='', &
            interpinic_flag='interp', readvar=readvar, data=this%herbivc_resp_patch)
    ...
    if ( carbon_type == 'c14')  then
       ...
       ! shsun
       call restartvar(ncid=ncid, flag=flag, varname='herbivc_14', xtype=ncd_double,  &
            dim1name='pft', long_name='', units='', &
            interpinic_flag='interp', readvar=readvar, data=this%herbivc_patch) 

       call restartvar(ncid=ncid, flag=flag, varname='herbivc_resp_14', xtype=ncd_double,  &
            dim1name='pft', long_name='', units='', &
            interpinic_flag='interp', readvar=readvar, data=this%herbivc_resp_patch) 
  ...
  subroutine SetValues ( this, &
    ...
    do fi = 1,num_patch
       ...
       this%herbivc_patch(i)            = value_patch
       this%herbivc_resp_patch(i)       = value_patch
    ...
    do fi = 1,num_column
       ...
       this%herbivc_col(i)              = value_column
       this%herbivc_resp_col(i)         = value_column
    end do
  ...
  subroutine Summary_carbonstate(this, bounds, num_allc, filter_allc, &
    ...
    call p2c(bounds, num_soilc, filter_soilc, &
         this%herbivc_patch(bounds%begp:bounds%endp), &
         this%herbivc_col(bounds%begc:bounds%endc))

    call p2c(bounds, num_soilc, filter_soilc, &
         this%herbivc_resp_patch(bounds%begp:bounds%endp), &
         this%herbivc_resp_col(bounds%begc:bounds%endc))
    ...
    do fc = 1,num_allc
       ...
       this%totc_col(c) =  this%totc_p2c_col(c) + &
            ...
            this%herbivc_col(c)             + & 
            this%herbivc_resp_col(c)   !shsun test    
