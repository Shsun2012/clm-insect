...
#include "shr_assert.h"
  ...
  type, public :: cnveg_nitrogenstate_type
     ...
     ! shsun
     real(r8), pointer :: herbivn_patch            (:) ! (gN/m2) pool for herbivore
     real(r8), pointer :: herbivn_col              (:) ! (gN/m2) column-level herbivn  
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%herbivn_patch            (begp:endp)) ; this%herbivn_patch            (:) = nan
    allocate(this%herbivn_col              (begc:endc)) ; this%herbivn_col              (:) = nan
  ...
  subroutine InitHistory(this, bounds)
    ...
    ! shsun
    this%herbivn_patch(begp:endp) = spval
    call hist_addfld1d (fname='HERBIVN', units='gN/m^2', &
         avgflag='A', long_name='patch-level herbivore nitrogen', &
         ptr_patch=this%herbivn_patch)
    ...
    this%herbivn_col(begc:endc) = spval
    call hist_addfld1d (fname='HERBIVNCOL', units='gN/m^2', &
         avgflag='A', long_name='column-level herbivore nitrogen', &
         ptr_col=this%herbivn_col)
  ...
  subroutine Restart ( this,  bounds, ncid, flag, leafc_patch, &
    ...
    ! shsun
     call restartvar(ncid=ncid, flag=flag, varname='herbivn', xtype=ncd_double,  &
         dim1name='pft', long_name='', units='', &
         interpinic_flag='interp', readvar=readvar, data=this%herbivn_patch) 
  ...
  subroutine SetValues ( this, &
    ...
    do fi = 1,num_patch
       ...
       this%herbivn_patch(i)            = value_patch
    ...
    do fi = 1,num_column
       ...
       this%herbivn_col(i)    = value_column
  ...
  subroutine Summary_nitrogenstate(this, bounds, num_allc, filter_allc, &
    ...
    do fc = 1,num_allc
       ...
       ! add herbivory for balance check (shsun)
